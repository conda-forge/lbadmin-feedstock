...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lbadmin-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10579&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lbadmin-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lbadmin` can be installed with:

```
conda install lbadmin
```

It is possible to list all of the versions of `lbadmin` available on your platform with:
